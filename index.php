...
use Saddam\Image\Container\Builder;
...
$image->width = 200;
$image->height = 100;
$image->text = "This is my demo";
$image->size_center_x = 200;
$image->size_center_y = 200;
$image->size_width = 250;
$image->size_height = 250;
...
// echo (new Session)->get("stringText");
